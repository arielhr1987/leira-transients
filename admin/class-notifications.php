...
/**
 * This class handles all notifications inside admin to the end user within the plugin.
...
class Notifications{
	 ...
	 * @var string
	 */
	protected $cookie = 'leira_transients_notification';
	 ...
	 *
	 * Initializes the messages from the cookie if it exists.
	 *
	 * @since      1.0.0
	 */
